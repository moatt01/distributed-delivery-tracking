...
This project simulates a real-world logistics platform where shipments can be created, tracked, and managed through REST APIs. It is designed to demonstrate production-level backend architecture using Spring Boot.
